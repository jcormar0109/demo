...
return new #[CustomDashboardsPluginMigration(MigrationName::WidgetsTable)] class extends Migration
{
    /**
     * Run the migrations.
     */
    ...
    {
        Schema::create('filament_cd_widgets', function (Blueprint $table): void {
            $table->id();
