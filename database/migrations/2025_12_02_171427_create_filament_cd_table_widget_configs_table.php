...
return new #[CustomDashboardsPluginMigration(MigrationName::TableWidgetConfigsTable)] class extends Migration
{
    /**
     * Run the migrations.
     */
    ...
    {
        Schema::create('filament_cd_table_widget_configs', function (Blueprint $table): void {
            $table->id();
