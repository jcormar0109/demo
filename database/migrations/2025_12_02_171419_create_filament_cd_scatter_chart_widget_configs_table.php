...
return new #[CustomDashboardsPluginMigration(MigrationName::ScatterChartWidgetConfigsTable)] class extends Migration
{
    /**
     * Run the migrations.
     */
    ...
    {
        Schema::create('filament_cd_scatter_chart_widget_configs', function (Blueprint $table): void {
            $table->id();
