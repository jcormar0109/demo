...
return new #[CustomDashboardsPluginMigration(MigrationName::DoughnutChartWidgetEloquentDsConfigsTable)] class extends Migration
{
    /**
     * Run the migrations.
     */
    ...
    {
        Schema::create('filament_cd_doughnut_chart_widget_eloquent_ds_configs', function (Blueprint $table): void {
            $table->id();
