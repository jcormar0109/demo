...
return new #[CustomDashboardsPluginMigration(MigrationName::LineChartWidgetConfigsTable)] class extends Migration
{
    /**
     * Run the migrations.
     */
    ...
    {
        Schema::create('filament_cd_line_chart_widget_configs', function (Blueprint $table): void {
            $table->id();
