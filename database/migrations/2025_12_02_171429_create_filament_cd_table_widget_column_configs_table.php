...
return new #[CustomDashboardsPluginMigration(MigrationName::TableWidgetColumnConfigsTable)] class extends Migration
{
    /**
     * Run the migrations.
     */
    ...
    {
        Schema::create('filament_cd_table_widget_column_configs', function (Blueprint $table): void {
            $table->id();
