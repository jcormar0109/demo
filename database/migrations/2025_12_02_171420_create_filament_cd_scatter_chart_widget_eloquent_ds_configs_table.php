...
return new #[CustomDashboardsPluginMigration(MigrationName::ScatterChartWidgetEloquentDsConfigsTable)] class extends Migration
{
    /**
     * Run the migrations.
     */
    ...
    {
        Schema::create('filament_cd_scatter_chart_widget_eloquent_ds_configs', function (Blueprint $table): void {
            $table->id();
    ...
    {
        Schema::dropIfExists('filament_cd_scatter_chart_widget_eloquent_ds_configs');
    }
};
